/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 02e13ab445cfe7a3087fb2b937a09529)
// Runtime types generated with workerd@1.20260921.1 2025-09-01 nodejs_compat
interface __BaseEnv_Env {
	UPLOADS: R2Bucket;
	DB: D1Database;
	EMAIL: SendEmail;
	ASSETS: Fetcher;
	ADMIN_EMAILS: "joshua@hu.tt";
	EMAIL_FROM: "desktop.fyi <hello@desktop.fyi>";
	SITE_URL: "https://desktop.fyi";
	BOARD: DurableObjectNamespace<import("./worker/index").BoardDurableObject>;
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "ADMIN_EMAILS" | "EMAIL_FROM" | "SITE_URL">> {}
}
